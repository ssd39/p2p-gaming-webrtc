...
#define JUICE_MAX_SDP_STRING_LEN 4096
	...
	typedef void (*juice_cb_candidate_t)(juice_agent_t *agent, const char *sdp, void *user_ptr, int userid);
	...
	typedef void (*juice_cb_recv_t)(juice_agent_t *agent, const char *data, size_t size,
									void *user_ptr);
	typedef void (*juice_cb_recv1_t)(socket_t socket, const char *data, size_t size,
									 void *user_ptr, struct sockaddr *sockaddrdata, int userid);
